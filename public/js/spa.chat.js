...
spa.chat = (function() {
    ...
    var configMap = {
        ...
        slider_opened_title: '点击关闭窗口',
        slider_closed_title: '点击打开窗口',
    ...
    setSliderPosition, onClickToggle,
    configModule, initModule,
    removeSlider, handleResize, writeChat,
    writeAlert, scrollChat, clearChat,
     ...
     * @param  {Boolean} is_user     [description]
     * @return {[type]}              [description]
     */
